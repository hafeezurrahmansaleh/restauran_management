...
$("input[type='checkbox']").change(function () {
    ...
    if (this.checked) {
        ...
        $("#cal_form").removeClass("form-light");
        $("#cal_form").addClass("form-dark");
        $("#cal_form input").removeClass("form-input-light");
        $("#cal_form input").addClass("form-input-dark");
    ...
    // light theme (default)
        ...
        $(".container").addClass("container-light");
        $("#cal_form").removeClass("form-dark");
        $("#cal_form").addClass("form-light");
        $("#cal_form input").removeClass("form-input-dark");
        $("#cal_form input").addClass("form-input-light");
